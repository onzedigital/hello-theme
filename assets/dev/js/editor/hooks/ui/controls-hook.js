    ...
    getHelloThemeControls() {
        return {
            ...
            hello_header_submenu_width: {
                selector: '.site-header',
                callback: ($element, args) => {
                    const classPrefix = 'submenu-dropdown-',
                        inputOptions = args.container.controls.hello_header_submenu_width.options,
                        inputValue = args.settings.hello_header_submenu_width;
